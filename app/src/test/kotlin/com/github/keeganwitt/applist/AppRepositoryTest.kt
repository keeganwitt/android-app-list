...
class AppRepositoryTest {
    ...
    @Test
    fun `given installed apps, when loadApps called, then apps are returned`() = runTest {
    ...
    @Test
    fun `given system apps, when loadApps called with showSystemApps false, then system apps are filtered out`() = runTest {
    ...
    @Test
    fun `given system apps, when loadApps called with showSystemApps true, then system apps are included`() = runTest {
        val userApp = createApplicationInfo("com.test.userapp", "User App", isSystemApp = false)
        val systemApp = createApplicationInfo("com.android.system", "System App", isSystemApp = true)
        val packageInfo = createPackageInfo("1.0.0")
    ...
    @Test
    fun `given apps without launch intent, when loadApps called, then apps are filtered out`() = runTest {
        val appInfo = createApplicationInfo("com.test.app", "Test App")
    ...
    @Test
    fun `given apps, when loadApps called with descending true, then apps are sorted in descending order`() = runTest {
    ...
    @Test
    fun `given app throws exception, when loadApps called, then exception is caught and crash is reported`() = runTest {
        val appInfo = createApplicationInfo("com.test.app", "Test App")
    ...
    @Test
    fun `given apps with usage stats, when loadApps called, then last used times are populated`() = runTest {
        val appInfo = createApplicationInfo("com.test.app", "Test App")
        val packageInfo = createPackageInfo("1.0.0")
    ...
    @Test
    fun `given apps with permissions, when loadApps called, then permission counts are populated`() = runTest {
        val appInfo = createApplicationInfo("com.test.app", "Test App")
        val packageInfo = createPackageInfo("1.0.0").apply {
    ...
    @Test
    fun `given reload true, when loadApps called, then usage stats are reloaded`() = runTest {
        val appInfo = createApplicationInfo("com.test.app", "Test App")
        val packageInfo = createPackageInfo("1.0.0")
